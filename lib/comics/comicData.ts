...
const ISSUE_1_PAGES = [
  ...
  "/assets/comics/issue-1/03-meet-the-people.png",
  ...
  "/assets/comics/issue-1/09-hidden-in-plain-sight.png",
  "/assets/comics/issue-1/10-what-employees-truly-value.png",
...
export const COMIC_ISSUES: ComicIssue[] = [
  {
    ...
    description:
      "Jordan's first day at Vantemere Group reveals how total rewards shapes culture, trust, and retention — often in ways employees feel before they can name.",
    coverImage: ISSUE_1_PAGES[0],
    pages: [...ISSUE_1_PAGES],
    available: true,
    accent: "#C8963E",
