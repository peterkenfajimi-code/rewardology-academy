      ...
      <section className="ess-cover">
        ...
        <div className="ess-cover-in">
          ...
          <p className="ess-cover-desc">
            {ESSENTIALS_ARTICLES.length} easy to read articles covering compensation, benefits,
            pay equity, analytics, incentives, and the future of HR rewards — for professionals
            who lead with insight.
          </p>
        ...
        <div className="ess-cover-stats">
          <div>
            <div className="ess-stat-n">{ESSENTIALS_ARTICLES.length}</div>
            <div className="ess-stat-l">Articles</div>
          </div>
          <div>
            <div className="ess-stat-n">{ESSENTIALS_TOPICS.length}</div>
